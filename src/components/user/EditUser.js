...
export default function EditUser() {
  ...
  const headers = {
    ...
    useEffect(() => { const getUser = axios.get(`${process.env.REACT_APP_HOST}/api/devices/${id}`,{headers})
    .then((data)=>{
  ...
  if (confirmed) {
    ...
    axios.patch(`${process.env.REACT_APP_HOST}/api/devices/${id}`, formData,{headers})
      .then(response => {
